  ...
  template: `
    ...
    >
      ...
      @for (i of _slider.thumbIndexes(); track i) {
        <span
          class="border-ring ring-ring/50 absolute block size-3 shrink-0 rounded-full border bg-white transition-[color,box-shadow] select-none after:absolute after:-inset-2 hover:ring-3 focus-visible:ring-3 focus-visible:outline-hidden active:ring-3"
          brnSliderThumb
        ></span>
      }
    </div>
